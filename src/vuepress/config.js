...
module.exports = {
  ...
  plugins: [
    ...
    [
      ...
      {
        sidebarDepth: 3,
        exclude: /\.(git|gitignore|vuepress)$/
      }
    ],
  ...
  themeConfig: {
    ...
    //       collapsable: false,
    //       children: [
    //         ["plugin/Plugin-Introduction", "Introduction"],
    //         ["plugin/Plugin-Tutorial", "Tutorial"],
    ...
    //       collapsable: false,
    //       children: [
    //         ["are-middleware/ARE.md", "Advanced"]
    ...
    //       collapsable: false,
    //       children: [
    //         ["are-remote-api/ARE-Webserver.md", "Webserver"],
    //         ["are-remote-api/REST-API", "REST"],
    //         ["are-remote-api/AsTeRICS Websocket.md", "Websocket"]
    //       ]
    //     },
    ...
    //       collapsable: false,
    //       children: [
    //         ["at-solution/AT_solution_development", "Introduction"],
    //         ["at-solution/AT-solution-demos", "Demos"],
    //         ["at-solution/AsTeRICS Solutions", "Tutorial"],
    //         ["at-solution/APE", "AsTeRICS Packaging Environment (APE)"]
    //       ]
    //     }
    //   ],
